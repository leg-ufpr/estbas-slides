...
resultado**, entretanto seu espaço de amostral pode ser estabelecido com precisão.

- Podemos atribuir probabilidades aos *eventos* deste
espaço amostral, dando origem a idéia de **distribuição de probabilidade**.

- Em geral vamos distinguir a distribuição de probabilidade de v.a discretas e contínuas.
