...
- A **Inferência Estatística** é fundamentada na **Teoria das
Probabilidades**.
...
**experimentos aleatórios**. Isso ocorre em duas etapas:
...
aleatório}. Exemplo: lançamento de uma moeda, lançamento de um dado, altura de uma pessoa, etc.
